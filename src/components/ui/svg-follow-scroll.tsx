...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[350vh] w-screen flex-col items-center overflow-hidden bg-canvas px-4 text-ink"
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        ...
        <p className="font-jakarta-sans relative z-10 max-w-2xl text-xl font-medium text-ink">
      ...
      <div className="rounded-4xl font-jakarta-sans w-full translate-y-[200vh] bg-ink pb-10 text-canvas">
